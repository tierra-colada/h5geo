...
class DevCurveParam():
    ...
    @typing.overload
    def __init__(self, lengthUnits: str, temporalUnits: str, angleUnits: str, setActive: bool = False, chunkSize: int = 1000) -> None: ...
    @property
...
class LogCurveParam():
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, lengthUnits: str, dataUnits: str, chunkSize: int = 1000) -> None: ...
    @property
    def chunkSize(self) -> int:
        """
        :type: int
...
class SeisParam():
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, domain: Domain, dataType: SeisDataType, surveyType: SurveyType, lengthUnits: str, temporalUnits: str, dataUnits: str, nTrc: int, nSamp: int, srd: float = 0, trcChunk: int = 20000, stdChunk: int = 1000) -> None: ...
    @property
...
class MapParam():
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, nX: int, nY: int, X0: float, Y0: float, dX: float, dY: float, domain: Domain, lengthUnits: str, dataUnits: str) -> None: ...
    @property
    def X0(self) -> float:
        """
        :type: float
...
class WellParam():
    ...
    def __init__(self) -> None: ...
    @typing.overload
    def __init__(self, headX: float, headY: float, kb: float, uwi: str, lengthUnits: str) -> None: ...
    @property
...
class H5Map(H5BaseObject, H5Base, _H5Map, _H5BaseObject, _H5Base):
    ...
    def getDataUnits(self) -> str: ...
    def getDomain(self) -> Domain: ...
    def getOrigin(self, lengthUnits: str = str()) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
    def getSpacing(self, lengthUnits: str = str()) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
    def getLengthUnits(self) -> str: ...
...
class H5Well(H5BaseObject, H5Base, _H5Well, _H5BaseObject, _H5Base):
    ...
    def getHeadCoord(self, lengthUnits: str = str()) -> numpy.ndarray[numpy.float64, _Shape[m, 1]]: ...
    ...
    def getUWI(self) -> str: ...
    def getWellContainer(self) -> _H5WellContainer: ...
    def setHeadCoord(self, xy: numpy.ndarray[numpy.float64, _Shape[2, 1]], lengthUnits: str = str()) -> bool: ...
