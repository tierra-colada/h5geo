...
void H5WellContainer_py(
  ...
  py_obj
      ...
      .def("createWell", py::overload_cast<std::string&, WellParam&, CreationType>(&H5WellContainerImpl::createWell))
      .def("createWell", py::overload_cast<h5gt::Group, WellParam&, CreationType>(&H5WellContainerImpl::createWell))
