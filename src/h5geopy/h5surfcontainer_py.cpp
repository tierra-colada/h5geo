...
void H5SurfContainer_py(
  ...
  py_obj
      ...
      .def("createSurf", py::overload_cast<std::string&, SurfParam&, CreationType>(&H5SurfContainerImpl::createSurf))
      .def("createSurf", py::overload_cast<h5gt::Group, SurfParam&, CreationType>(&H5SurfContainerImpl::createSurf))
