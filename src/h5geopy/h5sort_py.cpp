...
"Input parameter `v` is a vector");
  ...
  m.def("sort_rows", &ext::sort_rows<const Eigen::MatrixXf>,
        py::arg("M"),
...
"M_sorted = M(ind, Eigen::all)");
  m.def("sort_rows", &ext::sort_rows<const Eigen::MatrixXd>,
        py::arg("M"));
